jQuery(function(){
	...
	$('#tabs-content').before('<ul id="tabs"><li id="tab-simple" class="selected">Simple Search</li><li id="tab-advanced" class="middle">Advanced Search</li><li id="tab-browse">Browse Metadata</li></ul>');
