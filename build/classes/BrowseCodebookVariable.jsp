  ...
  <div id="main">
  	...
  	<div id="navDiv">
  	  <ul id="navList">
  	    ...
  	    <li id="tab-browse" class="selected"><a href="BrowseDataCodebook.jsp">Browse Metadata</a></li>
  	  </ul>
      <div class="clear"></div>
    </div>
     
    <div id="content">
      <p><a href="BrowseDataCodebook.jsp#<%= request.getAttribute("backInfo") %>">&lt;&lt; Back To List</a><br /></p>
