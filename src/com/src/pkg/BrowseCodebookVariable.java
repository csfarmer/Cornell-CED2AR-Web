...
/**
 * Servlet implementation class BrowseCodebookVariable
 */
@WebServlet("/BrowseCodebookVariable")
public class BrowseCodebookVariable extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BrowseCodebookVariable() {
        super();
